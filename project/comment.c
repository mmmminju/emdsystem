...
int status = MENU;
int score;
static int obstacleX=700;   //레벨1에서 장애물 X좌표
static int obstacleY=300;   //레벨1에서 장애물 y좌표

static int obstacleX2_1=750;   //레벨2에서 장애물1 X좌표
static int obstacleY2_1=100;   //레벨2에서 장애물1 y좌표
static int obstacleX2_2=250;   //레벨2에서 장애물2 X좌표
static int obstacleY2_2=300;   //레벨2에서 장애물2 y좌표

static int obstacleX3_1=300;   //레벨3에서 장애물1 X좌표
static int obstacleY3_1=100;   //레벨3에서 장애물1 y좌표
static int obstacleX3_2=250;   //레벨3에서 장애물2 X좌표
static int obstacleY3_2=400;   //레벨3에서 장애물2 y좌표
static int obstacleX3_3=410;   //레벨3에서 장애물3 X좌표
static int obstacleY3_3=330;   //레벨3에서 장애물3 y좌표

void *score_timer(void *data)  //점수 타이머???
{
    while (1)
    {
        if (score == 0)
...
void level_2_obstacle(int OnOff)   //레벨2_장애물
{
...
void level_3_obstacle(int OnOff)   //레벨3_장애물
{
